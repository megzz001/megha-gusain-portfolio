...
export default function App() {
  ...
  const [darkMode, setDarkMode] = useState<boolean>(() => {
    ...
    return true; // Default to dark mode for elegant technical aesthetic
  });
  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 ${darkMode ? 'dark bg-brand-bg-dark text-neutral-100 grid-bg-dark' : 'bg-neutral-50 text-neutral-800 grid-bg-light'}`}>
